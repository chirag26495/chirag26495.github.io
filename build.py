...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    I am a PhD student at the <a href="https://cvit.iiit.ac.in/" target="_blank">Center for Visual Information Technology</a> (CVIT - <a href="https://mobility.iiit.ac.in/" target="_blank">Mobility</a>), <a href="https://cvit.iiit.ac.in/" target="_blank">IIIT Hyderabad</a>, supervised by <a href="https://scholar.google.co.in/citations?user=oLJTcXIAAAAJ&hl=en" target="_blank">Prof. Ravi Kiran Sarvadevabhatla</a>. My research lies at the intersection of computer vision and machine learning, with a focus on addressing the challenges of developing ADAS solutions for dense, unstructured traffic environments. I am currently working on video-based driver behavior understanding and interactive video question answering to enhance explainability in driving scenarios. I completed my B.E. from Birla Institute of Technology, Mesra in 2017, where I worked on robotic vision projects with the college robotics society. Before starting my PhD in 2022, I developed computer vision systems for driver behavior monitoring and satellite-based cropland analysis in industry.
                </p>
