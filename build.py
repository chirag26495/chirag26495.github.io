...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    ...
                    I completed my B.E. from Birla Institute of Technology, Mesra in 2017. The highlight of my undergraduate research was developing a real-time shuttlecock tracking and trajectory estimation algorithm that won the MathWorks special prize at ABU ROBOCON 2015. After graduating, I worked across multiple companies, developing real-world computer vision applications for driver behavior monitoring and cropland monitoring from satellite imagery. In 2022, I began my PhD at the <a href="https://cvit.iiit.ac.in/" target="_blank">CVIT Lab</a> (<a href="https://mobility.iiit.ac.in/" target="_blank">Mobility</a> group), under the guidance of <a href="https://scholar.google.co.in/citations?user=oLJTcXIAAAAJ&hl=en" target="_blank">Prof. Ravi Kiran Sarvadevabhatla</a>.
                </p>
